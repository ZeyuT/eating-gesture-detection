#/bin/bash
#PBS -N zeyut
#PBS -l select=1:ncpus=16:mem=125gb:ngpus=1:gpu_model=v100:interconnect=any
...
cp /home/zeyut/eat_detection/workspace/eating-gesture-detection/inputs_multi_train.txt /scratch1/zeyut/eat_detection

inputs=( $(sed -n ${PBS_ARRAY_INDEX}p inputs_multi_train.txt) )
