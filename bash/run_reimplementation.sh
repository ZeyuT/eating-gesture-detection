...
cp -r /home/zeyut/eat_detection/workspace/eating-gesture-detection/reimplementation/pre_trained/ /scratch1/zeyut/eat_detection/reimplementation/
...
python ./train_model.py ${inputs[0]} ${inputs[1]}
